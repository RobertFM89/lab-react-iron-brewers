...
const BEER_URL = 'https://ih-beers-api2.herokuapp.com/beers/new';
...
function AddBeerPage() {
  ...
  const handleImageUrl = (e) => setImage_url(e.target.value);
  const handleFirstBrewed = (e) => setFirst_brewed(e.target.value);
  const handleBrewersTips = (e) => setBrewers_tips(String(e.target.value));
  const handleAttenuationLevel = (e) => setAttenuation_level(e.target.value);
